 ...
 */
final class Version20200507212424 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE action_plan DROP state_of_efficacy, DROP current_state, CHANGE exigency_interested_party_id exigency_interested_party_id INT DEFAULT NULL, CHANGE risk_id risk_id INT DEFAULT NULL, CHANGE opportunity_id opportunity_id INT DEFAULT NULL, CHANGE opportunity_reevalution_id opportunity_reevalution_id INT DEFAULT NULL, CHANGE historical_risk_id historical_risk_id INT DEFAULT NULL, CHANGE historical_opportunity_id historical_opportunity_id INT DEFAULT NULL, CHANGE objective_id objective_id INT DEFAULT NULL, CHANGE historical_objective_id historical_objective_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE action_plan ADD CONSTRAINT FK_ABBBE073AB7B6BCE FOREIGN KEY (current_state_action_plan_id) REFERENCES current_state_action_plan (id)');
        $this->addSql('ALTER TABLE action_plan ADD CONSTRAINT FK_ABBBE073AF297FDA FOREIGN KEY (state_efficacy_action_plan_id) REFERENCES state_efficacy_action_plan (id)');
        $this->addSql('CREATE INDEX IDX_ABBBE073AB7B6BCE ON action_plan (current_state_action_plan_id)');
        $this->addSql('CREATE INDEX IDX_ABBBE073AF297FDA ON action_plan (state_efficacy_action_plan_id)');
        ...
        $this->addSql('ALTER TABLE interseted_party CHANGE power power INT DEFAULT NULL, CHANGE influence influence INT DEFAULT NULL, CHANGE interest interest INT DEFAULT NULL, CHANGE weight weight INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE action_plan DROP FOREIGN KEY FK_ABBBE073AB7B6BCE');
        $this->addSql('ALTER TABLE action_plan DROP FOREIGN KEY FK_ABBBE073AF297FDA');
        $this->addSql('DROP INDEX IDX_ABBBE073AB7B6BCE ON action_plan');
        $this->addSql('DROP INDEX IDX_ABBBE073AF297FDA ON action_plan');
        $this->addSql('ALTER TABLE action_plan ADD state_of_efficacy VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD current_state VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE exigency_interested_party_id exigency_interested_party_id INT DEFAULT NULL, CHANGE risk_id risk_id INT DEFAULT NULL, CHANGE opportunity_id opportunity_id INT DEFAULT NULL, CHANGE opportunity_reevalution_id opportunity_reevalution_id INT DEFAULT NULL, CHANGE historical_risk_id historical_risk_id INT DEFAULT NULL, CHANGE historical_opportunity_id historical_opportunity_id INT DEFAULT NULL, CHANGE objective_id objective_id INT DEFAULT NULL, CHANGE historical_objective_id historical_objective_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE interseted_party CHANGE weight weight INT DEFAULT NULL, CHANGE power power INT DEFAULT NULL, CHANGE influence influence INT DEFAULT NULL, CHANGE interest interest INT DEFAULT NULL');
