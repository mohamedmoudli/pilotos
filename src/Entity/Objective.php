...
class Objective
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Enjeu", inversedBy="objectives")
    ...
    public function getProcessLi(): ?Processus
    {
        return $this->ProcessLi;
    }

    public function setProcessLi(?Processus $ProcessLi): self
    {
        $this->ProcessLi = $ProcessLi;
